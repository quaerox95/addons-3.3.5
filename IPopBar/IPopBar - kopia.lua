...
--[[ Modified functions from ActionButton.lua
 Our button handler functions in a neat table ]]
local buttonHandler = {}
function buttonHandler:OnEnter()
	GameTooltip:SetOwner(self, "ANCHOR_NONE")
	GameTooltip:SetPoint("BOTTOMRIGHT", allB[11*db.NumRows], "TOPRIGHT", 3, 3) -- positioning or wtf?
...
-- IPopBarFrame.t2a:SetTexture("Interface\\MainMenuBar\\UI-MainMenuBar-NightElf")
IPopBarFrame.t2a:SetWidth(38)
IPopBarFrame.t2a:SetHeight(43)
IPopBarFrame.t2a:SetPoint("BOTTOM", 22, 0) -- 22 = default?
IPopBarFrame.t2a:SetTexCoord(0, 0.1484375, 0.33203125, 0.5)
IPopBarFrame.t2a:SetAlpha(0)
-- IPopBarFrame.t2a:SetAlpha(1)
 --IPopBarFrame.t2a:SetScale(0.82)
...
local IPopBarFrameBar = CreateFrame("Button", "IPopBarFrameBar", MainMenuBar, "SecureHandlerEnterLeaveTemplate, SecureHandlerAttributeTemplate")
 ...
 IPopBarFrameBar.bg1:SetAlpha(0) -- removed background to match the rest of actionbars /Asuri
 -- IPopBarFrameBar.bg1:SetAlpha(1)
 --IPopBarFrameBar.bg1:SetScale(0.82)
...
IPopBarFrameBar.bg2:SetAlpha(0)
-- IPopBarFrameBar.bg2:SetAlpha(1)
 ...
 IPopBarFrameBar.bg3:SetAlpha(0)
 -- IPopBarFrameBar.bg3:SetAlpha(1)
...
IPopBarToggleButton:SetAlpha(0) -- removing the alpha cause annoying /Asuri
...
function IPopBar:ShowMicroButtons()
	...
	-- WorldMapMicroButton:Show() -- old /Asuri
	AchievementMicroButton:Show() -- new
	PVPMicroButton:Show() -- new
	LFGMicroButton:Show() -- new
...
function IPopBar:HideMicroButtons()
	-- WorldMapMicroButton:Hide() -- old /Asuri
	AchievementMicroButton:Hide() -- new
	PVPMicroButton:Hide() -- new
	LFGMicroButton:Hide() -- new
	...
	UpdateMicroButtons() -- added in hopes of hiding TalentMicroButton when bar is toggled xd
end
